...
| [Clipboard](../../../../../welcome/blob/staging/help/processes/process/subprocesses/signal.md) | Display a text message that can be copied|  Useful when the customer gets a code for a voucher for example  | -         |[How to *Placeholder*](detailed.md#signal) |
