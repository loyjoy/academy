...
![Condition - function](condition_function.png "Condition function")
  ...
  ### ConvertTimestamptMSToDateTime
    ...
    [Check out the official pattern options](https://docs.oracle.com/javase/7/docs/api/java/text/SimpleDateFormat.html)
    argument3: Timezone id - the id of the timezone of the location you are interested in 
